                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                <div class="text-center">
                                    <h3 class="">Two Set-up Verification Code</h3>
                                ...
                                <div class="form-body">
                                    <form class="row g-3" action="{{ route('account.verify_code') }}" method="POST">
                                        ...
                                        <div class="col-12">
                                            <label for="inputEmailAddress" class="form-label">Verification Code</label>
                                            <input type="number"
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-primary"><i
                                                        class='bx bx-user'></i>Verify Code</button>
                                            </div>
                                        </div>
